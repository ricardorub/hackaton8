          ...
          contents: [
            {
              parts: [
                {
                  text: `Eres un asistente que solo habla en ${language} y responde preguntas sobre las páginas de la aplicación móvil. Páginas: Login, Mapa de centros de votación. Pregunta: "${input}"`,
                },
              ],
            },
          ],
